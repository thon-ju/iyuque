...
class MyPaginatedDataTableState extends State<MyPaginatedDataTable> {
  ...
  void _onRowsPerPageChangedSet(int value){
    setState(() {
      _firstRowIndex = 0;
    });
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.onRowsPerPageChanged != null) {
      final List<Widget> availableRowsPerPage = widget.availableRowsPerPage
          .where((int value) => value <= widget.totalCount || value == widget.rowsPerPage)
          ...
          child: Align(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<int>(
                ...
                onChanged: _onRowsPerPageChangedSet,
    ...
    footerWidgets.addAll(<Widget>[
      ...
      IconButton(
          ...
          onPressed: (!_rowCountApproximate && (_firstRowIndex + widget.rowsPerPage >= widget.totalCount)) ? null : _handleNext
      ),
